...
public class LoginFrame extends JFrame {
    ...
    //CAMBIADO, AHORA LO CONECTAMOS CON PerfilUsuarioFrame.java CUANDO SE LOGEA
    private void login() {  // METODO PARA EL INICIO DE SESION
    ...
    for (Usuario u : usuarios) {
        if (u.getCorreo().equals(correo) && u.getContrasena().equals(pass)) {
            ...
            // ABRIR EL MENU PRINCIPAL (PERFIL + BIBLIOTECA + CONFIG + RACHA)
